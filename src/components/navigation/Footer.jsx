...
const Footer = ({ width = '380px', height = '55px', dark = false }) => {
  return (
    <footer
      className={`${dark ? 'bg-[#1d1d1d] text-[#f5f5f5]' : 'bg-[#f5f5f5] text-[#1d1d1d]'} px-6 py-1 mb-5 rounded-full flex justify-between items-center mx-auto`}
      style={{
    ...
    >
      ...
      <div className="flex justify-end space-x-4">
        <a
          ...
          className={`${dark ? 'text-[#f5f5f5]' : 'text-[#1d1d1d]'} text-2xl transition-colors duration-300 hover:text-[#6f02c6]`}
          aria-label="GitHub"
        >
          <FaGithub />
        </a>
