...
const SectionTemplate = ({ imgsource, imgalt, imgtext, title, text: TextComponent, cv = false, socials = false }) => {
  ...
  const y = scrollY * 0.1; // Adjust this multiplier as needed for the desired effect
    ...
    <section ref={ref} className="h-screen w-full snap-start flex justify-center items-center p-4 md:p-8">
      ...
      >
        <div className="flex flex-col items-center">
          <img src={imgsource} draggable="false" alt={imgalt} className="rounded-2xl max-w-xs md:max-w-sm h-72 md:h-96 object-cover mb-4" />
