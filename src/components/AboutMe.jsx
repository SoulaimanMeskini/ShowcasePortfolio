...
import AboutMeImage from '../assets/AboutMeImage1.jpg';
import AboutMeImage2 from '../assets/AboutMeImage2.jpg';
import AboutMeImage3 from '../assets/AboutMeImage3.jpg';
import {
  AboutTitle1, AboutTitle2, AboutText1, AboutText2, AboutImgText1, AboutImgText2,
  AboutTitle3, AboutText3, AboutImgText3
} from '../text/text';
...
const AboutMe = ({ setShowLogo, scrollRef }) => {
  ...
  return (
    <div className="relative h-screen w-screen md:snap-y md:snap-mandatory overflow-y-scroll no-scrollbar scroll-container" ref={scrollRef}>
      ...
      <motion.section
        ...
        transition={{ duration: 0.7 }}
      >
        <SectionTemplate imgsource={AboutMeImage} imgalt="Portrait" imgtext={AboutImgText1} title={AboutTitle1} text={AboutText1} />
      </motion.section>
      <motion.section
        id="section3"
        className="h-full w-full md:snap-center"
        ...
        transition={{ duration: 0.7 }}
      >
        <SectionTemplate imgsource={AboutMeImage2} imgalt="Van Gogh" imgtext={AboutImgText2} title={AboutTitle2} text={AboutText2} cv={true} />
      </motion.section>
      <motion.section
        id="section4"
        className="h-full w-full md:snap-center"
        ...
        transition={{ duration: 0.7 }}
      >
        <SectionTemplate imgsource={AboutMeImage3} imgalt="Modern Portrait" imgtext={AboutImgText3} title={AboutTitle3} text={AboutText3} socials={true} />
      </motion.section>
    </div>
  );
};
